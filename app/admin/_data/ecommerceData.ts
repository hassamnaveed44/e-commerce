...
export interface EcommerceMetrics {
  ...
  totalOrders: { value: number; change: string; positive: boolean };
  averageOrderValue: { value: number; change: string; positive: boolean };
  activeCustomers: { value: number; change: string; positive: boolean };
}

export const ecommerceMetrics: EcommerceMetrics = {
  totalRevenue: { value: 45231.89, change: "+20.1% from last month", positive: true },
  totalOrders: { value: 2350, change: "+180.1% from last month", positive: true },
  averageOrderValue: { value: 89.45, change: "+19.0% from last month", positive: true },
  activeCustomers: { value: 573, change: "+201 since last hour", positive: true },
};
